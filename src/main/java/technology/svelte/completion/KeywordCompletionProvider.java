...
public class KeywordCompletionProvider extends CompletionProvider<CompletionParameters> {
    // constant lists
    private static final String[] KEYWORDS = {"#if", "else", "elseif", "/if", "#each", "/each"};
...
//		for(String filter: FILTERS) FILTER_LOOKUPS.add(LookupElementBuilder.create(filter));
    ...
    protected void addCompletions(@NotNull CompletionParameters params,
        ...
        PsiElement currElement = params.getPosition()
                .getOriginalElement();
        if (currElement.getNode()
                .getElementType() == SvelteTokenTypes.SVELTE_PARAMS) {
