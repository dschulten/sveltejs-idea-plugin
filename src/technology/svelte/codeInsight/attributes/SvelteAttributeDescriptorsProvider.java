...
public class SvelteAttributeDescriptorsProvider implements XmlAttributeDescriptorsProvider {
    ...
    public XmlAttributeDescriptor[] getAttributeDescriptors(XmlTag context) {
        ...
        for (XmlAttribute attribute : attributes) {
            ...
            if(attributeName
                    .contains(":")) {
                result.put(attributeName, new SvelteAttributeDescriptor(context.getProject(), attributeName, null));
            }
        }
    ...
    public XmlAttributeDescriptor getAttributeDescriptor(String attributeName, XmlTag context) {
        ...
        if (attributeName.contains(":")) {
            ret = new SvelteAttributeDescriptor(context.getProject(), attributeName, null);
        } else {
            ret = null;
        }
        return ret;
